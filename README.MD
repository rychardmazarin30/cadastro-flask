...
<p>Estando os validators ok, o usuário é cadastrado no banco de dados com sua senha criptografada. <strong>PS: </strong>Usei a Lib Bcrypt para criptografar as senhas no banco de dados</p>
<p></p>
